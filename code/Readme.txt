Infos for installing RocketLogger:
...
gcc -Wall -O3 -o rl_low_level.o -c rl_low_level.c -lprussdrv
...
gcc -Wall -O3 util.o calibration.o pwm.o gpio.o rl_hw.o rl_low_level.o lib_util.o rl_lib.o rl_util.o rocketlogger.c -o rocketlogger -pthread -lprussdrv -lrt

# compile deamon
gcc -Wall -O3 util.o calibration.o pwm.o gpio.o rl_hw.o rl_low_level.o lib_util.o rl_lib.o rl_util.o rl_deamon.c -o rl_deamon -pthread -lprussdrv -lrt
